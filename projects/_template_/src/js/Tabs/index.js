...
function Tabs(selector, startPaneIndex) {
  ...
  this.refresh = function() {
      ...
      for (var i = 0; i < state.quantity; i++) {
        if (tabSelectors[i].hasAttribute('data-tab-selector--is-active')) tabSelectors[i].removeAttribute('data-tab-selector--is-active');

        if (tabPanes[i].hasAttribute('data-tab-pane--is-active')) tabPanes[i].removeAttribute('data-tab-pane--is-active');
